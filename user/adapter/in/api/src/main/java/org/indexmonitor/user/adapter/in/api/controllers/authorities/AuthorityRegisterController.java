...
@AllArgsConstructor
public class AuthorityRegisterController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> register(@RequestBody AuthorityRegisterRequest request){
        ...
        BaseResponse response = authorityRegisterUseCase.register(request);
