...
public class ResetPasswordService implements ResetPasswordUseCase {
    ...
    private final ResetPasswordSendLinkPort resetPasswordSendLinkPort;
    ...
    private String port;
    @Override
    public BaseResponse<ResetPasswordRegisterRequest> start(ResetPasswordStartRequest startCommand) {
        try {
            startCommand.validateSelf();
            User user = tryRetrieveUser(startCommand.getEmail());
            ResetPasswordRegisterRequest command = new ResetPasswordRegisterRequest();
    ...
    @Override
    public BaseResponse sendToken(ResetPasswordRegisterRequest command) {
        try {
    ...
    @Override
    public BaseResponse updatePassword(ResetPasswordUpdateRequest command) {
        try {
            command.validateSelf();
    ...
    private void validateQuestionAnswer(ResetPasswordRegisterRequest command, User user){
    ...
    private void sendResetPasswordLink(String email, String link){
        resetPasswordSendLinkPort.send(email,link);
    }
